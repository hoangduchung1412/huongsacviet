 ...
 <div class="">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="title">Cập nhật thông tin nhà cung cấp</h4>
        </div>
        <div class="modal-body " >
          ...
          <form method="post" action="<?php echo $action; ?>">
            ...
            <div class="form-group row">
                <label class="col-md-4 text-md-right font-weight-bold" >Mã nhà cung cấp : </label>
                <input type="text" class="col-md-6 form-control" name="mancc" value="<?php echo isset($record->mancc) ? $record->mancc :''; ?>">
            </div>

            <div class="form-group row">
                <label class="col-md-4 text-md-right font-weight-bold" >Tên nhà cung cấp : </label>
        ...
        <div class="modal-footer">
          <a href="index.php?controller=ncc"><button type="button" class="btn btn-danger">Go back</button></a>
        </div>
      </div>
