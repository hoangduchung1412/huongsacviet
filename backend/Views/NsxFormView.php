...
<div class="">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="title">Cập nhật thông tin nhà sản xuất</h4>
        </div>
        <div class="modal-body " >
          ...
          <form method="post" action="<?php echo $action; ?>">
            ...
            <div class="form-group row">
                <label class="col-md-2 text-md-right font-weight-bold" >Mã nhà sản xuất : </label>
                <input type="text" class="col-md-9 form-control" name="mansx" value="<?php echo isset($record->mansx) ? $record->mansx :''; ?>">
            </div>

            <div class="form-group row">
                <label class="col-md-2 text-md-right font-weight-bold" >Tên nhà sản xuất : </label>
        ...
        <div class="modal-footer">
          <a href="index.php?controller=nsx"><button type="button" class="btn btn-danger">Go back</button></a>
        </div>
      </div>
