...
<main class="main position-relative">
    <div class="cotainer">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header h5"><b>Nhà Cung Cấp</b> </div>
                    <nav class="navbar navbar-light bg-light justify-content-between">
                        <?php if($_SESSION['permission']==1 || $_SESSION['permission']==4): ?>
                        <a href="index.php?controller=ncc&action=create" class="btn btn-dark text-light"><i class="fas fa-plus pr-1"></i>  Thêm </a>
                        <?php else:  ?>
                    ...
                    <div class="card-body">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                <?php foreach ($data as $rows): ?>
                                    <tr>
                                        <th width = "15%" scope="row"><?php echo $rows->mancc; ?></th>
                                        ...
                                        <td width = "5%"> <a href="index.php?controller=ncc&action=view&id=<?php echo $rows->id ?>"><button  value="" type="button" class="btn btn-outline-primary"> <i class="fas fa-eye"></i></button></a> </td>
                                        
                                        <?php if($_SESSION['permission']==1 || $_SESSION['permission']==3 || $_SESSION['permission']==4): ?>
                                        <td width = "5%"> <a href="index.php?controller=ncc&action=update&id=<?php echo $rows->id ?>"><button  value="" type="button" class="btn btn-outline-warning"> <i class="fas fa-pen"></i></button></a> </td>
                                        
                                        <td width = "5%"><a href="index.php?controller=ncc&action=delete&id=<?php echo $rows->id ?>" onclick="return window.confirm('Are you sure?');"><button value="" type="button" class="btn btn-outline-danger"> <i class="fas fa-trash-alt"></i> </button></a> </td> 
                                        <?php else: ?>
                        ...
                        <ul class="pagination">
                            ...
                            <?php for($i=1;$i<=$numPage;$i++): ?>
                                <li class="page-item"><a class="page-link" href="index.php?controller=ncc&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                            <?php endfor; ?>
