...
<div class="">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="title">Cập nhật thông tin khu vực</h4>
        </div>
        <div class="modal-body " >
          ...
          <form method="post" action="<?php echo $action; ?>">
            ...
            <?php 
                ...
                //thuc hien truy van
                $query = $conn->query("select * from districts where parent_id = 0 order by id desc");
        ...
        <div class="modal-footer">
          <a href="index.php?controller=districts"><button type="button" class="btn btn-danger">Go back</button></a>
        </div>
      </div>
