...
<div class="modal-dialog">
   ...
   <div class="modal-header">
     <h4 class="modal-title" id="title"> Thông tin nhà sản xuất </h4>
   </div>
   <div class="modal-body" >
       ...
       <div class="form-group">
            <label class="col-md-4 text-md-right font-weight-bold" >Mã nhà sản xuất : </label>
           <span class="col-md-6"><?php echo $record->mansx; ?></span>
       </div>
